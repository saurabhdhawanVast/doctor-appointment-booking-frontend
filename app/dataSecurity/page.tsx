        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              At DABMS, safeguarding your data is our top priority. Here’s how
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-600">
                  We use state-of-the-art encryption technologies to ensure that
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-black bg-opacity-50 z-10 flex items-center justify-center p-6 rounded-lg">
              <div className="text-center text-white">
                ...
                <p>
                  Our end-to-end encryption ensures that only you and authorized
...
// "use client";
// import React from "react";
// import { FaLock, FaShieldAlt, FaRegClipboard, FaDatabase } from "react-icons/fa";
// import { motion } from "framer-motion";
...
//             </h2>
//             <p className="text-gray-600 max-w-3xl mx-auto">
//               At DABMS, safeguarding your data is our top priority. Here’s how we ensure the security of your personal and medical information.
//             </p>
//           </motion.div>
...
//                 <p className="text-gray-600">
//                   We use state-of-the-art encryption technologies to ensure that all your personal and medical data is securely protected against unauthorized access.
//                 </p>
//               </div>
//             </motion.div>
...
//                 <p className="text-gray-600">
//                   Our robust authentication mechanisms ensure that only authorized users can access sensitive information. We employ multi-factor authentication to enhance security.
//                 </p>
//               </div>
//             </motion.div>
...
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold mb-2">Regular Data Backups</h3>
//                 <p className="text-gray-600">
//                   We perform regular backups of all data to ensure that in case of any unforeseen issues, your information remains intact and recoverable.
//                 </p>
//               </div>
//             </motion.div>
...
//                 <p className="text-gray-600">
//                   We adhere to all relevant data protection regulations and standards to ensure that your information is handled in accordance with the highest security practices.
//                 </p>
//               </div>
//             </motion.div>
//           </div>
...
//             transition={{ duration: 0.7, delay: 0.3 }}
//           >
//             Discover how we implement security measures through our comprehensive approach to data protection.
//           </motion.p>
...
//             />
//             <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 p-6 rounded-lg">
//               <div className="text-center text-white">
//                 <h3 className="text-xl font-semibold mb-4">End-to-End Encryption</h3>
//                 <p>
//                   Our end-to-end encryption ensures that only you and authorized parties have access to your sensitive data, maintaining confidentiality and integrity.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//           </h2>
//           <p className="text-gray-400 mb-4">
//             For any concerns about our data security practices, feel free to <a href="/contact-us" className="text-blue-400 hover:underline">contact us</a>.
//           </p>
//           <p className="text-gray-400">© 2024 DABMS. All rights reserved.</p>
//         </div>
//       </footer>
